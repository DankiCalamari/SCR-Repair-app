...
SMS_TEMPLATES = [
    ...
    },
    {
        ...
        "body": "Hi {{customer_name}}, your {{device_type}} ({{device_model}}) is repaired. Total: ${{total_amount}}. Please contact us to arrange pickup. – Sunset Country Repairs",
        "variables": ["customer_name", "device_type", "device_model", "total_amount"],
    },
    {
    ...
    },
    {
        ...
        "body": "Hi {{customer_name}}, this is a reminder for your repair appointment tomorrow. Ticket {{ticket_number}} – {{device_type}} at {{appointment_time}}. – Sunset Country Repairs",
        "variables": ["customer_name", "ticket_number", "device_type", "appointment_time"],
    },
    {
        "name": "Cancelled – Feedback Request",
...
EMAIL_TEMPLATES = [
    ...
    },
    {
        ...
        "body_html": "<p>Hi {{customer_name}},</p><p>Your repair quote for <strong>{{device_type}}</strong> ({{device_model}}) is ready.</p><table style='margin: 16px 0'><tr><td>Labour</td><td>${{labour_cost}}</td></tr><tr><td>Parts</td><td>${{parts_cost}}</td></tr><tr><td><strong>Total</strong></td><td><strong>${{total_amount}}</strong></td></tr></table><p>To approve this quote, please visit:<br><a href='{{quote_link}}'>{{quote_link}}</a></p><p>Regards,<br>Sunset Country Repairs</p>",
        "variables": ["customer_name", "ticket_number", "device_type", "device_model", "labour_cost", "parts_cost", "total_amount", "quote_link"],
    },
    {
        "name": "Repair Complete Notification",
        "subject": "Your device is ready – {{ticket_number}}",
        "body": "Hi {{customer_name}},\n\nGreat news! Your {{device_type}} ({{device_model}}) has been repaired.\n\nTicket: {{ticket_number}}\nCompleted: {{completed_date}}\nTotal: ${{total_amount}}\n\nPlease contact us to arrange pickup.\n\nRegards,\nSunset Country Repairs",
        "body_html": "<p>Hi {{customer_name}},</p><p>Great news! Your <strong>{{device_type}}</strong> ({{device_model}}) has been repaired.</p><p>Ticket: <strong>{{ticket_number}}</strong><br>Completed: {{completed_date}}<br>Total: ${{total_amount}}</p><p>Please contact us to arrange pickup.</p><p>Regards,<br>Sunset Country Repairs</p>",
        "variables": ["customer_name", "ticket_number", "device_type", "device_model", "completed_date", "total_amount"],
    },
    {
        "name": "Invoice",
        ...
        "body_html": "<p>Hi {{customer_name}},</p><p>Please find your invoice details below for ticket <strong>{{ticket_number}}</strong>.</p><table style='margin: 16px 0'><tr><td>Subtotal</td><td>${{subtotal}}</td></tr><tr><td>GST</td><td>${{gst_amount}}</td></tr><tr><td><strong>Total Due</strong></td><td><strong>${{total_amount}}</strong></td></tr><tr><td>Due Date</td><td>{{due_date}}</td></tr></table><p>Payment can be made via bank transfer.</p><p>Regards,<br>Sunset Country Repairs</p>",
    ...
    },
    {
        ...
        "body_html": "<p>Hi {{customer_name}},</p><p>It's been a while since we repaired your <strong>{{device_type}}</strong> (ticket {{ticket_number}}). We hope everything is working well!</p><p>If you have any issues or feedback, please let us know.</p><p>Regards,<br>Sunset Country Repairs</p>",
        "variables": ["customer_name", "ticket_number", "device_type"],
    },
    {
        "name": "Lead Acknowledgement",
        "subject": "Thanks for your enquiry!",
        "body": "Hi {{customer_name}},\n\nThanks for contacting Sunset Country Repairs about your {{device_type}}.\n\nWe'll review your enquiry and get back to you within 24 hours.\n\nIf you need urgent assistance, please reply to this email.\n\nRegards,\nSunset Country Repairs",
        "body_html": "<p>Hi {{customer_name}},</p><p>Thanks for contacting Sunset Country Repairs about your <strong>{{device_type}}</strong>.</p><p>We'll review your enquiry and get back to you within 24 hours.</p><p>If you need urgent assistance, please reply to this email.</p><p>Regards,<br>Sunset Country Repairs</p>",
        "variables": ["customer_name", "device_type"],
    },
    {
        "name": "Welcome New Customer",
        "subject": "Welcome to Sunset Country Repairs!",
        "body": "Hi {{customer_name}},\n\nThanks for choosing Sunset Country Repairs! We're a mobile repair service specialising in phone, tablet, and computer repairs.\n\nYou can track your repair status online using your ticket number. Simply visit our website and enter {{ticket_number}}.\n\nIf you have any questions, just reply to this email.\n\nBest regards,\nThe Sunset Country Repairs Team",
        "body_html": "<p>Hi {{customer_name}},</p><p>Thanks for choosing Sunset Country Repairs! We're a mobile repair service specialising in phone, tablet, and computer repairs.</p><p>You can track your repair status online using your ticket number. Simply visit our website and enter <strong>{{ticket_number}}</strong>.</p><p>If you have any questions, just reply to this email.</p><p>Best regards,<br>The Sunset Country Repairs Team</p>",
        "variables": ["customer_name", "ticket_number"],
    },
    {
        ...
        "body_html": "<p>Hi {{customer_name}},</p><p>Your repair appointment has been confirmed!</p><table style='margin: 16px 0'><tr><td>Date</td><td>{{appointment_date}}</td></tr><tr><td>Time</td><td>{{appointment_time}}</td></tr><tr><td>Ticket</td><td>{{ticket_number}}</td></tr><tr><td>Device</td><td>{{device_type}} ({{device_model}})</td></tr></table><p>If you need to reschedule, please contact us.</p><p>Regards,<br>Sunset Country Repairs</p>",
        "variables": ["customer_name", "ticket_number", "device_type", "device_model", "appointment_date", "appointment_time"],
    },
    {
    ...
    {
        "name": "Diagnosis Complete",
        "subject": "Diagnosis complete – {{ticket_number}}",
        "body": "Hi {{customer_name}},\n\nWe've completed diagnosing your {{device_type}} ({{device_model}}). Your ticket number is {{ticket_number}}.\n\nWe'll send you a quote shortly for your review and approval.\n\nRegards,\nSunset Country Repairs",
        "body_html": "<p>Hi {{customer_name}},</p><p>We've completed diagnosing your <strong>{{device_type}}</strong> ({{device_model}}). Your ticket number is <strong>{{ticket_number}}</strong>.</p><p>We'll send you a quote shortly for your review and approval.</p><p>Regards,<br>Sunset Country Repairs</p>",
        "variables": ["customer_name", "ticket_number", "device_type", "device_model"],
    },
    {
        "name": "Parts Ordered",
        "subject": "Parts ordered for your repair – {{ticket_number}}",
        "body": "Hi {{customer_name}},\n\nWe've ordered the parts needed for your {{device_type}} ({{device_model}}) repair. Your ticket number is {{ticket_number}}.\n\nWe'll update you once the parts arrive.\n\nRegards,\nSunset Country Repairs",
        "body_html": "<p>Hi {{customer_name}},</p><p>We've ordered the parts needed for your <strong>{{device_type}}</strong> ({{device_model}}) repair. Your ticket number is <strong>{{ticket_number}}</strong>.</p><p>We'll update you once the parts arrive.</p><p>Regards,<br>Sunset Country Repairs</p>",
        "variables": ["customer_name", "ticket_number", "device_type", "device_model"],
    },
]
