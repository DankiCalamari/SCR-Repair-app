...
export default function ContactPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Sunset Country Repairs Mildura</title>
        <meta name="description" content="Get in touch with Sunset Country Repairs. Call or message us for a free quote on phone, tablet, laptop & console repairs in Mildura and Sunraysia." />
        <meta name="keywords" content="contact, quote, phone repair, tablet repair, Mildura, Sunraysia" />
        <link rel="canonical" href="https://sunsetcountryrepairs.com.au/contact" />
      </Helmet>
